...
public:
    ...
    void async_send(base_implementation_type& impl,
        ...
        start_op(impl, reactor::write_op, p.p, is_continuation, true,
                 ((impl.state_ & socket_ops::stream_oriented) && buffer_sequence_adapter<asio::const_buffer,
    ...
    void async_receive(base_implementation_type& impl,
        ...
        start_op(impl,
                 ...
                 ((impl.state_ & socket_ops::stream_oriented) && buffer_sequence_adapter<asio::mutable_buffer,
